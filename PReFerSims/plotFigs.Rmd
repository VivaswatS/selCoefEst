...
ggplot(df) + 
  ...
  scale_color_manual(values=c('grey20','firebrick')) +  scale_fill_manual(values=c('grey60','grey20')) + 
    ...
    geom_hline(yintercept=1, linetype="dashed", color = "grey50", size=2) +
  guides(color = guide_legend(override.aes = list(fill = "white"))) + 
    labs(x=TeX('$\\gamma$'),y='ratio of Var') + scale_y_continuous(trans='log10') +
  theme(axis.text=element_text(size=rel(1)),
        axis.title=element_text(size=rel(1.)),
        legend.position="none",#c(0.25,0.8),
        legend.text=element_text(size=rel(1.)),
        legend.title=element_text(size=rel(1.)))
ggsave('~/selCoefEst/figs/gaininfo_onlyratiovar.jpeg',height=7,width=9)
```
