...
```{r}
finalRes <- read.table('resfiles/finalRes2023-12-19pt2.csv',header=T,sep=',')
...
p <- finalRes %>% dplyr::mutate(est=est*40000) %>%
  ...
  scale_y_continuous(trans='log',breaks=c(30,100,300,1000,3000),labels=c(30,100,300,1000,3000)) + 
  ...
  #+ geom_hline(yintercept=100/20000,color='red') + 
p
```
